...
public class SignInOrganizationActivity extends AppCompatActivity {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if ( task.isSuccessful() ){
                            ...
                            if ( task.getException() instanceof FirebaseAuthUserCollisionException) {
                                Toast.makeText(SignInOrganizationActivity.this, "Usuario inexistente", Toast.LENGTH_SHORT).show();
                            }else {
                                Toast.makeText(SignInOrganizationActivity.this, "no se pudo registrar el usuario", Toast.LENGTH_LONG).show();
                            }
                        }
