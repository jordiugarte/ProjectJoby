                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if ( task.isSuccessful() ){
                            Toast.makeText(SignInUser.this , " Bienvenido ", Toast.LENGTH_LONG).show();
                            //TODO make the call of the next activity
                        }else{
                            if ( task.getException() instanceof  FirebaseAuthUserCollisionException ) {
                                Toast.makeText(SignInUser.this, "Usuario inexistente", Toast.LENGTH_SHORT).show();
                            }else {
                                Toast.makeText(SignInUser.this, "no se pudo registrar el usuario", Toast.LENGTH_LONG).show();
                            }
                        }
